...
description: >
  ...
  central inquiry question, a five-phase inquiry cycle, and student-generated
  understanding, with curriculum links and differentiation integrated
  throughout. Supports structured, guided, and open inquiry models. Trigger
  on requests like "build an inquiry unit on ecosystems," "design a guided
  inquiry unit for Year 6 history," or "create an IBL unit with an open
  inquiry model." Works standalone and always grounds the unit in curriculum
...
- **Guided inquiry is the better-evidenced default, not just a convention.**
  Meta-analytic evidence (Hattie's synthesis) finds inquiry has a genuine
  positive effect specifically in its teacher-guided form, and evidence on
  minimally guided instruction (Kirschner, Sweller & Clark; Alfieri et al.)
  finds fully open inquiry carries real risk for students without strong
  prior knowledge of the topic — they lack the base to self-generate
  effective investigation strategies. This is a lean, not a rule with no
  exceptions: recommend guided as the starting point in Step 1, but let the
  teacher choose structured or open where it genuinely fits the class.
- **"Open" inquiry still needs scaffolding, not full withdrawal of guidance.**
  The strongest-performing discovery-based studies pair student-directed
  investigation with worked examples, modelling, and elicited explanation.
  Open inquiry in this skill means students own the question and the
  method — not that the teacher stops teaching.
...
Establish content descriptions for all relevant subjects. IBL units often
draw across learning areas — cover each that will be genuinely represented.
Use whatever curriculum lookup capability is available in this session; if
none is, ask the teacher to paste the relevant content descriptions and
achievement standards. Never invent standards from training data.
...
If the teacher has already indicated this earlier in the conversation, use
that silently. If not, ask:
...
>
> Guided inquiry is the strongest starting point for most classes — the
> evidence for it is stronger and more consistent than for fully open
> inquiry, especially where students don't yet have strong prior knowledge
> of the topic. Open works well once students have that base or have
> practised the investigation skills before."
...
*For open inquiry:* Where the topic is new to students, include a brief
explicit knowledge-building activity (a short input, demonstration, or
shared text) before question generation — students generate more
productive questions once they have some foundation to question from.
Then facilitate a class discussion to identify the 2–3 most generative
student questions that will drive the unit.
...
*For open inquiry:* Students independently pursue their sub-questions, with
the teacher as co-inquirer and resource connector who still actively
scaffolds — modelling investigation moves and offering worked examples
where students get stuck — rather than fully withdrawing guidance.
...
## Evidence base
- Hattie / Visible Learning MetaX — teacher-guided inquiry (questions posed
  and methods designed by students under teacher guidance) has a moderate
  positive effect on achievement, above the threshold for a year's growth.
  <https://www.visiblelearningmetax.com/influences/view/inquiry-based_teaching>
- Kirschner, Sweller & Clark (2006) — minimally guided instruction
  disadvantages novice learners who lack the prior knowledge to
  self-generate effective investigation strategies.
  <https://itgs.ict.usc.edu/papers/Constructivism_KirschnerEtAl_EP_06.pdf>
- Alfieri et al. (2011) — guided discovery outperforms both unassisted
  discovery and other enhanced-discovery variants; unassisted discovery
  underperforms explicit instruction.
  <https://eric.ed.gov/?id=EJ933606>
- AERO (2023) — guided/explicit instruction produces better recall and
  transfer than unguided approaches for novices, with inquiry most
  effective once foundational knowledge is in place.
